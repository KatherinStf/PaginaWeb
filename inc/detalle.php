    ...
    <main class="main">
        <section class="group group--color">
            <div class="container">
                ...
                <p class="main__txt">Detalle de las compras </p>
            </div>
        </section>
...
function obtenerContactos() {
    ...
    try{
         return $conn->query("SELECT cedula_cliente, Nombre, Apellido, detalle,estado, codigo FROM registro_cuenta INNER JOIN detalle_compra ON registro_cuenta.id_registro_cuenta=detalle_compra.id_registro_cuenta");
    } catch(Exception $e) {
                         ...
                         <?php $contactos = obtenerContactos(); 
                               ...
                               if($contactos->num_rows) { 
                                   ...
                                   <tr>
                                        ...
                                        <td><?php echo $contacto['cedula_cliente']; ?></td>
                                        <td><?php echo $contacto['Nombre']; ?></td>
                                        <td><?php echo $contacto['Apellido']; ?></td>
                                        <td><?php echo $contacto['detalle']; ?></td>
                                        <td><?php echo $contacto['estado']; ?></td>
                                        <td><?php echo $contacto['codigo']; ?></td>
