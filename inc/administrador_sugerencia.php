    ...
    <header class="main-header">
        <div class="container container--flex">
            ...
            <div class="main-header__contactInfo column column--50">
                ...
                <a class="menu__login " href="login.php?cerrar_sesion=true">Cerrar Sesión</a>
                <a class="menu__login " href="administrador.php">Volver </a>
                </p>
            </div>
        </div>
    </header>
    ...
    <main class="main">
        <section class="group group--color">
            <div class="container">
                ...
                <p class="main__txt">Detalle de las sugerencias o consultas hechas por usuarios </p>
            </div>
        </section>
  <div class="contenedor">      
<div class="container container--flex alto">
<!--TABLA QUE CARGA LOS REGISTROS DE LA BASE DE DATOS-->
<?php
function obtenerContactos() {
    include 'conexion.php';
    try{
         return $conn->query("SELECT Nombre, Apellido, Correo, Telefono, Direccion, Sugerencia_consulta  FROM formulario_contacto"
);
    } catch(Exception $e) {
                         ...
                         <?php $contactos = obtenerContactos(); 
                               ...
                               if($contactos->num_rows) { 
                                   ...
                                   <tr>
                                        ...
                                        <td><?php echo $contacto['Sugerencia_consulta']; ?></td>
...
<h2 class="centrado centradoSecundario"> Compras Canceladas</h2>
...
function obtenerAuditoria() {
    include 'conexion.php';
    try{
         return $conn->query("SELECT fecha, negacion  FROM auditoria"
);
    } catch(Exception $e) {
         echo "Error!!" . $e->getMessage() . "<br>";
         return false;
...
<table id="" class="">
                    <thead>
                         <tr>
                              ...
                              <th>Fecha</th>
                              <th>Negacion/Estado</th>
                         </tr>
                    </thead>

                    <tbody>
                         <?php $contactos = obtenerAuditoria(); 
                               ...
                               if($contactos->num_rows) { 
                                   ...
                                   <tr>
                                        ...
                                        <td><?php echo $contacto['negacion']; ?></td>
